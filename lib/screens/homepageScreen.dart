                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  GestureDetector(
                                    onTap: () =>
                                        _fetchActivities(context, 'Cairo'),
                                    child: Container(
                                      width: 182,
                                      height: 100,
                                      decoration: BoxDecoration(
                              ...
                              SizedBox(
                                ...
                                child: Consumer<Homepageactivityprovider>(
                                  builder: (context, provider, child) {
                                    final filteredActivities = provider
                                        .activities
                                        .where((activity) =>
                                            activity.category ==
                                            selectedCategory)
